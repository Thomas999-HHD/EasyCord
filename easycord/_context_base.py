...
class BaseContext:
    ...
    # ── Escape hatches (raw Discord access) ────────────────────

    @property
    def raw_interaction(self) -> discord.Interaction:
        """Raw discord.Interaction. Use this to drop down to discord.py."""
        return self.interaction

    @property
    def client(self) -> discord.Client:
        """Raw discord.Client. Use this to access low-level Discord API."""
