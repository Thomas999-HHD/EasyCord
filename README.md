...
EasyCord (the “Software”) is provided under a **dual-license model with a fair contribution system**:

1. **Free Use License (conditional)**
2. **Commercial License (optional alternative)**
3. **Revenue Share Model (default for qualifying commercial use)**

Use of the Software is permitted only under these terms.

---

## 2. Definitions

* **“Licensor”** means Rolling Codes.
* **“User”** means any individual or legal entity using the Software.
* **“Software”** means EasyCord, including all source code, plugins, and documentation.
* **“Commercial Use”** means use that generates revenue or supports business operations.
* **“SaaS”** means providing functionality over a network to third parties.
* **“Distribution”** means making the Software available to third parties.
* **“Annual Revenue”** means gross revenue attributable to the Software’s use.
* **“Net Revenue”** means gross revenue minus payment processing fees, platform fees, and taxes.

---

## 3. Free Use License

You may use, modify, and run the Software at no cost **only if ALL conditions are met**:
...
* Commercial use with **Annual Revenue < $10,000 USD**
...
* Offer the Software as a SaaS platform
* Distribute it within proprietary/closed-source software
* Use it in products/services with **Annual Revenue ≥ $10,000 USD**
...
## 4. Commercial Use (Above Threshold)

If your use exceeds **$10,000 USD Annual Revenue**, you must choose ONE:

### Option A — Commercial License

Obtain a commercial license from the Licensor.

Contact: Instagram **@hackerinwheels**
...
derived from the product or service using the Software.

---

## 5. Free Use Exception (“$10K of Heart”)

The Licensor recognizes that not all meaningful projects are defined by revenue.

If your project demonstrates strong community value, innovation, or public benefit (“$10,000 worth of heart”), you may request a **Free Use Exception**.

Contact: Instagram **@hackerinwheels**

Approval:

* Granted at the discretion of the Licensor
* Will not be unreasonably denied for legitimate use

---

## 6. Source Code Rights

You may:

* View, modify, and fork the Software

You may NOT:

* Re-license the Software
* Remove or alter this License
* Distribute the Software in violation of this License

---

## 7. No Lock-In Guarantee

Nothing in this License restricts your ability to:

* Stop using the Software
* Migrate to other frameworks
* Access underlying Discord libraries directly

---

## 8. Future Monetization

The Licensor may introduce:
...
These do not affect rights granted under this License for prior versions.

---

## 9. Revenue Share Terms

### 9.1 Scope

Applies when:

* The Software is a **core or material component** of a revenue-generating system
...
* Licensor may request reasonable verification

---

### 9.3 Alternative

Users may switch to a Commercial License at any time.
...
Upon termination, all rights to use the Software cease.
...
* $100 USD, OR
* THE AMOUNT PAID UNDER A COMMERCIAL LICENSE

---

## 14. Governing Law

This License shall be governed by the laws of the **jurisdiction in which the Licensor is established**.

---

## 15. Jurisdiction and Venue

All disputes shall be resolved in the courts within the jurisdiction of the Licensor.

---

## 16. Trademark

“EasyCord” and “Rolling Codes” are trademarks of the Licensor.
...
## 19. Summary (Non-Legal)

* Free under $10K revenue (or $10K worth of heart)
* Above that: pay or share (15%)
* Contact: @hackerinwheels
* No lock-in
